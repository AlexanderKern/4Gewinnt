...
/**
 * Die Klasse ermoeglicht die Attribute des Zugs in einem Objekt zu halten
 * und im gesamten Programm waehrend der Laufzeit darauf zuzugreifen
 * 
 * @author MajkenPlugge
 *
 */
...
public class ReusableZuege {
	...
	/**
	 * Setzt das Attribut Gegner auf true oder false und gibt an, ob der Zug vom
	 * Gegner oder der eigen KI gespielt wurden ist
	 * 
	 * @param gegner
	 *            Gegner
	 */
